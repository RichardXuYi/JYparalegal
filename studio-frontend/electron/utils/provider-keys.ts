...
export const CLAWX_OPENAI_IMAGE_PROVIDER_KEY = 'grandpoem-studio-openai-image';
...
export function getOpenClawProviderKeyForType(type: string, providerId: string): string {
  ...
  // Safety net: legacy plan account IDs (e.g. "qwen-124880ac") may still exist
  // in the database. Return them as-is so the runtime can resolve the key.
 ...
 * e.g. getAliasSourceTypes('minimax-portal') 鈫?['minimax-portal-cn']
 */
