...
function buildGrandPoemStudioUvConfigToml(): string {
  return [
    '# This file is managed by GrandPoem Studio.',
    '# It lets uv use GrandPoem Studio-selected mirrors even when host exec filters UV_INDEX_URL.',
...
function ensureGrandPoemStudioUvConfigFile(): string | null {
  ...
  try {
    ...
    logger.warn('Failed to write GrandPoem Studio uv config file:', err);
    return null;
  }
}
