/**
 * Persist GrandPoem Studio-managed plugin install records into OpenClaw's SQLite
 ...
 * GrandPoem Studio-authored records win over stale SQLite entries for the same plugin id.
 */
