 ...
 * the Electron IPC system to display UI in the GrandPoem Studio frontend.
 */
...
class DeviceOAuthManager extends EventEmitter {
    ...
    private async onSuccess(providerType: OAuthProviderType, token: {
        ...
        // 3. Save provider record in GrandPoem Studio's own store so UI shows it as configured
