...
export async function setImageGenerationConfig(
  ...
  return withConfigLock(async () => {
    ...
    // GrandPoem Studio image generation is configured as one explicit custom endpoint.
    // Keep OpenClaw from appending other authenticated image providers such as
    // minimax-portal/image-01 after the configured GrandPoem Studio image provider.
