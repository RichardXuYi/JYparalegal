 ...
 * `runtimeFile` says (defended by schema + extension checks) so GrandPoem Studio can
 ...
 * unlinks the off-disk runtime file at `runtimeFile`. This keeps GrandPoem Studio in
