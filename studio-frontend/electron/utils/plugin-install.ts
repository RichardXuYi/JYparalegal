...
/**
 * Official @openclaw/* channel plugins that GrandPoem Studio mirrors into
...
/**
 * Write or refresh plugins.installs.<id> for a GrandPoem Studio-mirrored official plugin.
...
const ALL_BUNDLED_PLUGINS = [
  ...
  { fn: ensureGrandPoemStudioOpenAiImagePluginInstalled, label: 'GrandPoem Studio OpenAI Image' },
] as const;
