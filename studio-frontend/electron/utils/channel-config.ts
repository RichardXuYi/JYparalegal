...
// schema validation errors.  GrandPoem Studio falls back to DEFAULT_ACCOUNT_ID
...
// but whose account payload contains nested strict-schema objects that GrandPoem Studio
...
function sanitizeDiscordGuildChannelConfig(channelConfig: unknown): void {
    ...
    // Backward compatibility for the older GrandPoem Studio-generated shape:
...
export async function saveChannelConfig(
    ...
    return withConfigLock(async () => {
        ...
        // but GrandPoem Studio still keeps channels.<id> as the local account-list source.
        ...
        // while preserving channels.<id> for GrandPoem Studio's account list UI.
