...
async function deleteSession(
  ...
  // After successful file deletion, trigger a gateway sessions.list refresh
  // to invalidate any in-memory cache the Gateway may hold. Without this,
  // subsequent sessions.list RPC calls could return stale data including
...
export function createSessionsApi(
  options?: { gatewayManager?: GatewayManager },
): CompleteHostServiceRegistry['sessions'] {
