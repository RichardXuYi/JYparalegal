...
import { isLegacyScope } from '../utils/user-scope';
 ...
 * dist/extensions/. If GrandPoem Studio previously mirrored one of those ids into
...
export async function syncGatewayConfigBeforeLaunch(
  ...
  try {
    ...
    // Always refresh trusted install metadata through GrandPoem Studio —this must not
...
function ensureScopedStateDirInitialized(): void {
  ...
  try {
    ...
    const seed = { agents: { defaults: { workspace: join(stateDir, 'workspace') } } };
