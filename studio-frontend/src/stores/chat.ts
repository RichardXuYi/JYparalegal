...
// Sessions hard-deleted by this profile. The Gateway keeps deleted sessions in
// memory and re-serves their history, so loads targeting these keys stay
// suppressed until the user sends a new message. Hydrated from localStorage.
