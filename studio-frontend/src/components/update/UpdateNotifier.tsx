...
const AVAILABLE_TOAST_ID = 'grandpoem-studio-update-available';
const DOWNLOADED_TOAST_ID = 'grandpoem-studio-update-downloaded';
 ...
 * Sonner toast (`UpdateToast`) that follows the active GrandPoem Studio theme.
 */
