  ...
  return (
    <div className="min-h-screen relative overflow-hidden bg-gradient-to-br from-slate-50 via-blue-50 to-purple-50 flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/3 left-1/3 w-[500px] h-[500px] bg-gradient-to-r from-blue-300/15 to-purple-300/15 rounded-full blur-3xl" />
      </div>
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-5">
              <div className="relative">
                <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-blue-600 via-blue-500 to-purple-600 flex items-center justify-center shadow-2xl shadow-blue-500/30 relative z-10">
                  <span className="text-white font-bold text-4xl tracking-tight">JY</span>
                </div>
                <div className="absolute -inset-2 bg-gradient-to-br from-blue-600/40 to-purple-600/40 rounded-3xl blur-xl animate-pulse" />
              </div>
              <div>
                <h1 className="text-3xl font-bold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">JYparalegal</h1>
                <p className="text-base text-slate-600 mt-1.5">给中国法律人用的 AI 合同工作台</p>
                <div className="flex items-center gap-2 mt-2">
                  <div className="h-1.5 w-1.5 rounded-full bg-blue-600" />
                  <span className="text-xs text-slate-500">合同审查 · 发起签署 · 证据留存</span>
                </div>
              </div>
            </div>

            <div className="space-y-4 pt-4">
              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-slate-100/50">
                ...
                <div>
                  <h3 className="font-semibold text-slate-800 mb-1">智能合同管理</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">AI 驱动的合同审查、风险评估与智能起草</p>
                </div>
              </div>
              <div className="flex items-start gap-4 p-4 rounded-xl bg-white/50 border border-slate-100/50">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-purple-500 to-purple-600 flex items-center justify-center shrink-0 shadow-lg shadow-purple-500/20">
                  <Building2 className="w-6 h-6 text-white" />
                </div>
                <div>
                  <h3 className="font-semibold text-slate-800 mb-1">企业级服务</h3>
                  <p className="text-sm text-slate-600 leading-relaxed">给中国法律人用的「会说人话、能干活、留得下证据」的 AI 工作台</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="w-full max-w-md mx-auto lg:mx-0">
          <Card className="shadow-2xl border-0 bg-white/90 backdrop-blur-md relative overflow-hidden text-slate-800">
            ...
            <CardContent className="space-y-5 pb-8">
              ...
              <Button
                className="w-full h-12 bg-gradient-to-r from-blue-600 via-blue-500 to-purple-600 hover:opacity-90 text-white font-semibold shadow-lg shadow-blue-500/30"
                size="lg"
