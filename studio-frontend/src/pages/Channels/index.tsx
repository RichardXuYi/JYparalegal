...
interface GatewayDiagnosticSnapshot {
  ...
  'grandpoem-studioLogTail': string;
...
function isGatewayDiagnosticSnapshot(value: unknown): value is GatewayDiagnosticSnapshot {
  ...
  return (
    ...
    && typeof snapshot['grandpoem-studioLogTail'] === 'string'
...
export function Channels() {
  ...
  return (
    <div data-testid="channels-page" className="flex flex-col h-full w-full dark:bg-background overflow-hidden">
            ...
            <div className="mb-8">
              ...
              <div className="space-y-4">
                {configuredGroups.map((group) => (
                  <div key={group.channelType} className="glass-card rounded-2xl p-4">
                    <div className="flex items-center justify-between gap-2 mb-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <div className="h-[40px] w-[40px] shrink-0 flex items-center justify-center rounded-lg shadow-sm">
                          <ChannelLogo type={group.channelType as ChannelType} className="h-5 w-5" />
                        </div>
              ...
              {unsupportedGroups.map((type) => {
                ...
                return (
                  <button
                    ...
                    className={cn(
                      'group flex items-start gap-4 p-4 rounded-2xl transition-all text-left glass-card hover:shadow-md hover:-translate-y-0.5'
                    )}
                  >
                    <div className="h-[46px] w-[46px] shrink-0 flex items-center justify-center rounded-lg shadow-sm mb-3">
                      <ChannelLogo type={type} className="h-6 w-6" />
                    </div>
...
function ChannelLogo({ type, className }: { type: ChannelType; className?: string }) {
  const imgClass = cn('w-[22px] h-[22px] dark:invert', className);
  switch (type) {
    case 'telegram':
      return <img src={telegramIcon} alt="Telegram" className={imgClass} />;
    case 'discord':
      return <img src={discordIcon} alt="Discord" className={imgClass} />;
    case 'whatsapp':
      return <img src={whatsappIcon} alt="WhatsApp" className={imgClass} />;
    case 'wechat':
      return <img src={wechatIcon} alt="WeChat" className={imgClass} />;
    case 'dingtalk':
      return <img src={dingtalkIcon} alt="DingTalk" className={imgClass} />;
    case 'feishu':
      return <img src={feishuIcon} alt="Feishu" className={imgClass} />;
    case 'wecom':
      return <img src={wecomIcon} alt="WeCom" className={imgClass} />;
    case 'qqbot':
      return <img src={qqIcon} alt="QQ" className={imgClass} />;
    default:
      return <span className="text-xl">{CHANNEL_ICONS[type as ChannelType] || '📡'}</span>;
  }
}
