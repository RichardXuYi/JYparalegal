...
export function ChatInput({ onSend, onStop, disabled = false, sending = false }: ChatInputProps) {
  ...
  useEffect(() => {
    ...
    window.addEventListener('jy-chat-prefill', onPrefill);
    return () => window.removeEventListener('jy-chat-prefill', onPrefill);
  }, []);
          ...
          <div className="mt-1.5 flex flex-wrap items-center gap-1">
            ...
            <Button
              ...
              className={cn(
                ...
                (sending || canSend)
                  ? 'bg-gradient-to-br from-indigo-500 to-violet-600 dark:from-orange-500 dark:to-red-600 text-white shadow-sm hover:opacity-90'
