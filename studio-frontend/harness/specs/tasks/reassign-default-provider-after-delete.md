...
intent: Keep GrandPoem Studio provider account state and the OpenClaw default model valid when the user deletes the current default provider while other provider accounts remain.
touchedAreas:
