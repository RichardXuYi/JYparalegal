...
intent: Ensure generated images delivered through the OpenClaw message tool remain visible in GrandPoem Studio chat even when Gateway does not append an assistant-media transcript bubble.
touchedAreas:
