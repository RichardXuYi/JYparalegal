 ...
 * shows a misleading "app cannot be closed" dialog even when GrandPoem Studio is not running.
 */
...
const PATCH_MARKER = 'GrandPoem Studio-patched: skip legacy uninstaller';

const SKIP_LEGACY_UNINSTALLER = [
  '  ; GrandPoem Studio-patched: skip legacy uninstaller on upgrades.',
