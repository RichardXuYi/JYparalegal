#!/usr/bin/env node
/**
 * Generates extension bridge files based on grandpoem-extensions.json and
...
function generateMainBridge(manifest) {
  ...
  if (installedExts.length === 0) {
    return [
      '// Auto-generated 鈥?no external main-process extensions installed.',
...
if (totalExternal === 0) {
  console.log('[ext-bridge] No external extensions configured 鈥?generated empty stubs.');
} else {
