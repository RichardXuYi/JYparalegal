...
const PATCHED_EXTRACT_MACRO = [
  ...
  '    ${if} $grandpoem-studioRollbackDir != ""',
  '      IfFileExists "$grandpoem-studioRollbackDir\\" 0 grandpoem-studio_extract_show_error',
  '      DetailPrint "Restoring previous GrandPoem Studio installation after failed update..."',
  '      SetOutPath $TEMP',
  '      RMDir /r "$INSTDIR"',
  '      Rename "$grandpoem-studioRollbackDir" "$INSTDIR"',
  '    ${endIf}',
