# GrandPoem Studio Application Icons
...
1. **macOS (.icns)**
   ...
   - Run: `iconutil -c icns -o icon.icns GrandPoem Studio.iconset`
...
- **Design**: Simplified monochrome version of main icon (GrandPoem Studio logo)
