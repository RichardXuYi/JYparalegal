...
if /i "%1"=="update" (
    echo openclaw is managed by GrandPoem Studio ^(bundled version^).
    echo.
    echo To update openclaw, update GrandPoem Studio:
    echo   Open GrandPoem Studio ^> Settings ^> Check for Updates
...
set OPENCLAW_EMBEDDED_IN=GrandPoem Studio
...
if "%_USE_BUNDLED_NODE%"=="1" (
    ...
    "%~dp0..\..\GrandPoem Studio.exe" "%OPENCLAW_ENTRY%" %*
)
