...
const PROVIDER_ID = 'grandpoem-studio-openai-image';
...
function buildProvider() {
  return createOpenAiCompatibleImageGenerationProvider({
    id: PROVIDER_ID,
    label: 'GrandPoem Studio OpenAI Images',
    ...
    response: {
      ...
      fileNamePrefix: 'grandpoem-studio-image',
      sniffMimeType: true,
    },
    missingApiKeyError: 'GrandPoem Studio OpenAI image API key missing',
    failureLabels: {
      generate: 'GrandPoem Studio OpenAI image generation failed',
      edit: 'GrandPoem Studio OpenAI image edit failed',
    },
  });
}
...
export const pluginEntry = definePluginEntry({
  id: PROVIDER_ID,
  name: 'GrandPoem Studio OpenAI Image',
  description: 'Independent OpenAI-compatible image generation provider managed by GrandPoem Studio.',
  register(api) {
