 ...
 * Also synchronizes GrandPoem Paralegal Studio local provider list with OpenClaw's actual config.
 */
...
> {
  ...
  for (const provider of providers) {
    ...
    // we should remove it from GrandPoem Paralegal Studio UI to stay consistent.
