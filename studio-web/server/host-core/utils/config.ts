 ...
 */
export const PORTS = {
  /** GrandPoem Paralegal Studio GUI development server port */
  CLAWX_DEV: 5173,
  
  /** GrandPoem Paralegal Studio GUI production port (for reference) */
  CLAWX_GUI: 23333,
...
export const APP_PATHS = {
  ...
  /** GrandPoem Paralegal Studio configuration directory */
  CLAWX_CONFIG: '~/.grandpoem-studio',
  
  /** Log files directory */
  LOGS: '~/.grandpoem-studio/logs',
} as const;
