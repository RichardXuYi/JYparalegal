...
import { getOpenClawConfigDir, getOpenClawDir, getOpenClawResolvedDir, getOpenClawSkillsDir, getResourcesDir } from './paths';
...
interface PreinstalledMarker {
    source: 'grandpoem-studio-preinstalled';
    slug: string;
    version: string;
    installedAt: string;
}
...
/**
 * Built-in skills bundled with GrandPoem Paralegal Studio that should be pre-deployed to
...
const PREINSTALLED_MARKER_NAME = '.grandpoem-studio-preinstalled.json';
