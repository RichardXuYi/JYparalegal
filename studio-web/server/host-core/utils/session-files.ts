 ...
 * `runtimeFile` says (defended by schema + extension checks) so GrandPoem Paralegal Studio can
 ...
 * unlinks the off-disk runtime file at `runtimeFile`. This keeps GrandPoem Paralegal Studio in
