...
// Web host runs this file as native ESM (tsx), where __dirname is undefined.
...
// 鈹€鈹€ Known plugin-ID corrections 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function fixupPluginManifest(targetDir: string): void {
  ...
  try {
    ...
    if (oldId && MANIFEST_ID_FIXES[oldId]) {
      ...
      logger.info(`[plugin] Fixed manifest ID: ${oldId} 鈫?${newId}`);
    }
  } catch {
  ...
  for (const entry of entryFiles) {
    ...
    for (const [wrongId, correctId] of Object.entries(MANIFEST_ID_FIXES)) {
      ...
      if (replaced !== content) {
        content = replaced;
        patched = true;
        logger.info(`[plugin] Patched plugin ID in ${entry}: "${wrongId}" 鈫?"${correctId}"`);
      }
    }
...
// 鈹€鈹€ Plugin npm name mapping 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
/**
 * Official @openclaw/* channel plugins that GrandPoem Paralegal Studio mirrors into
...
/**
 * Write or refresh plugins.installs.<id> for a GrandPoem Paralegal Studio-mirrored official plugin.
...
export function syncTrustedOfficialPluginInstallRecord(
  ...
  try {
    ...
    if (!existsSync(fsPath(getOpenClawConfigPath()))) {
      return false;
    }

    const raw = readFileSync(fsPath(getOpenClawConfigPath()), 'utf-8');
...
// 鈹€鈹€ pnpm-aware node_modules copy helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function copyPluginFromNodeModules(npmPkgPath: string, targetDir: string, npmName: string): void {
  ...
  const collected = new Map<string, string>(); // realPath 鈫?packageName
...
// 鈹€鈹€ Core install / upgrade logic 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function ensurePluginInstalled(
  ...
  if (existsSync(fsPath(targetManifest))) {
    ...
    logger.info(
      `[plugin] Upgrading ${pluginLabel} plugin: ${installedVersion} 鈫?${sourceVersion}`,
    );
  }
      ...
      if (npmPkgPath && existsSync(fsPath(join(npmPkgPath, 'openclaw.plugin.json')))) {
        ...
        if (sourceVersion && (!installedVersion || sourceVersion !== installedVersion)) {
          logger.info(
            ...
            `${installedVersion ? `: ${installedVersion} 鈫?${sourceVersion}` : `: ${sourceVersion}`} (dev/node_modules)`,
          );
          try {
...
// 鈹€鈹€ Per-channel plugin helpers 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
export function ensureGrandPoemStudioOpenAiImagePluginInstalled(): { installed: boolean; warning?: string } {
  return ensurePluginInstalled(
    'grandpoem-studio-openai-image',
    buildCandidateSources('grandpoem-studio-openai-image'),
    'GrandPoem Paralegal Studio OpenAI Image',
  );
}

// 鈹€鈹€ Bulk startup installer 鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€鈹€
...
const ALL_BUNDLED_PLUGINS = [
  ...
  { fn: ensureGrandPoemStudioOpenAiImagePluginInstalled, label: 'GrandPoem Paralegal Studio OpenAI Image' },
] as const;
