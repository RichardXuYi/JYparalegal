...
/**
 * tailwind-merge instance configured for GrandPoem Paralegal Studio's custom design tokens.
 *
 ...
 *   `text-meta`, `text-tiny`, `text-subtitle`, `text-2xs`, `text-stat` — *   is classified by twMerge as a *text color* instead of a font-size.
 *
 ...
 * Uses the GrandPoem Paralegal Studio-aware twMerge above so custom font-size tokens
