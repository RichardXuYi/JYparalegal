...
export function isGrandPoemStudioDesktopSessionKey(sessionKey: string): boolean {
 ...
 * added to a group, webhook ping). Hide those placeholder entries from GrandPoem Paralegal Studio
