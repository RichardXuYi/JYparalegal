    ...
    <div data-testid="models-page" className="flex flex-col h-full w-full dark:bg-background overflow-hidden">
      <div className="w-full max-w-5xl mx-auto flex flex-col h-full p-6 pt-8">
        ...
        <SettingsPageHeader
          ...
          titleTestId="models-page-title"
        />

        {/* Tabbed content: providers / token usage */}
        <Tabs defaultValue="models" className="flex flex-1 min-h-0 flex-col">
          <TabsList className="w-fit mb-5 shrink-0 rounded-full">
            <TabsTrigger value="models" className="rounded-full px-5" data-testid="models-tab-providers">
              {t('dashboard:models.title')}
            </TabsTrigger>
            <TabsTrigger value="usage" className="rounded-full px-5" data-testid="models-tab-usage">
          ...
          <TabsContent
            value="models"
            className="mt-0 flex-1 overflow-y-auto pr-2 pb-8 min-h-0 -mr-2"
          >
            <ProvidersSettings />
          </TabsContent>
